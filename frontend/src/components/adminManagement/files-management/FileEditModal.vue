<template>
  <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center p-4">
    <div class="relative rounded-lg max-w-lg w-full mx-auto shadow-xl overflow-hidden bg-white dark:bg-gray-800">
      <!-- 标题栏 -->
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <h3 class="text-lg font-medium text-gray-900 dark:text-white">编辑文件信息</h3>
      </div>
